...
from library import perform_gauss_newton, plot_mag_synth, calculate_B_dipole_final
...
B_arr = np.stack([Bx_arr_nT, By_arr_nT, Bz_arr_nT], axis=1)*1.e-09
...
Bx_rec2_detrend = (B_rec2[:,0]-B0_detrend[0])
By_rec2_detrend = (B_rec2[:,1]-B0_detrend[1])
